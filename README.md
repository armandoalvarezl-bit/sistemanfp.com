...
<head>
  ...
  <meta name="farmapos-web-db-api-url" content="https://script.google.com/macros/s/AKfycbwGGUxjvdyJhrjPZwjwujFMxbWMDDRwIxpB-SHgkvxsjbj-CKWSTp75Jb_LVUndpmIGYA/exec">
  <title>Nueva Farma | Ingreso</title>
  ...
  <main class="login-page-container">
    <section class="login-hero">
      ...
      <div class="login-hero-content">
        <div class="login-hero-brand">
          ...
          <h1 class="login-hero-tag"><span>Bienvenido a</span><span class="hero-accent">Nube Farma</span></h1>
          <p class="login-hero-subtitle">Tu punto de venta farmaceutico en la nube</p>
        </div>

        <p class="login-hero-copy">Administra ventas, inventario, clientes y caja desde un solo lugar, con la informacion de tu farmacia siempre organizada.</p>

        <div class="login-hero-features">
          <article class="feature-card">
            <div class="feature-icon"><i class="bi bi-shield-check"></i></div>
            <strong>Acceso seguro</strong>
            <p>Tu cuenta, licencia y datos de operacion se validan antes de entrar.</p>
          </article>
          <article class="feature-card">
            <div class="feature-icon"><i class="bi bi-bar-chart-line"></i></div>
            <strong>Control diario</strong>
            <p>Revisa ventas, retiros, cierres de caja e inventario sin perder el ritmo.</p>
          </article>
          <article class="feature-card">
            <div class="feature-icon"><i class="bi bi-speedometer2"></i></div>
            <strong>Listo para vender</strong>
            <p>Entra rapido al POS y atiende a tus clientes con una experiencia fluida.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="auth-card auth-card-main auth-card-login">
      <div class="auth-card-frame">
        ...
        <div class="auth-head">
          <h2>Hola, Nube Farma</h2>
          <p>Ingresa con tu usuario para continuar con ventas, inventario y administracion.</p>
        </div>
          ...
          <div class="auth-form-panel">
            <div class="auth-form-fields">
              <div class="form-field" id="loginLicenseField" hidden>
                ...
                <div class="auth-input-shell">
                  ...
                  <input id="loginLicense" class="form-control" type="text" autocomplete="off" placeholder="Codigo de licencia">
                </div>
              </div>
              <div class="form-field">
                <label for="loginUsername">Correo o usuario</label>
                <div class="auth-input-shell">
                  <i class="bi bi-person-fill"></i>
                  <input id="loginUsername" class="form-control" type="text" autocomplete="username" placeholder="usuario@nuevafarma.com" required>
                </div>
              </div>
              <div class="form-field">
            ...
            <div class="auth-form-bottom">
              <div class="auth-form-hint">
                ...
                <span id="loginLicenseHint">Usa las credenciales asignadas a tu farmacia. La licencia se valida automaticamente.</span>
              </div>
              <button class="btn btn-brand w-100 auth-submit" type="submit">
                <span>Entrar a Nube Farma</span>
